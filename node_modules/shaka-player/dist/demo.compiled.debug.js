...
shakaDemo.AssetCard.prototype.addStoreButton=function(){var a=this,b=function(a,b,c){b.classList.add("asset-card-corner-button");b=document.createElement("i");b.textContent=c;b.classList.add("material-icons");a.appendChild(b)},c=shakaDemoMain.getAssetUnsupportedReason(this.asset_,!0);c||goog.asserts.assert(this.asset_.storeCallback,"A storage callback is expected for all supported assets!");if(c)c=this.makeUnsupportedButton_("",c),b(c,c.parentElement||c,"get_app");else if(this.asset_.isStored()){var d=
...
ShakaDemoAssetInfo.prototype.addDescription=function(a){this.description=a;return this};ShakaDemoAssetInfo.prototype.addCertificateUri=function(a){this.certificateUri=a;return this};ShakaDemoAssetInfo.caseLessAlphaComparator_=function(a,b){return a.toLowerCase()<b.toLowerCase()?-1:a.toLowerCase()>b.toLowerCase()?1:0};ShakaDemoAssetInfo.prototype.addFeature=function(a){this.features.push(a);this.features.sort(ShakaDemoAssetInfo.caseLessAlphaComparator_);return this};
ShakaDemoAssetInfo.prototype.addKeySystem=function(a){this.isClear()&&(this.drm=[]);this.drm.push(a);this.drm.sort(ShakaDemoAssetInfo.caseLessAlphaComparator_);return this};ShakaDemoAssetInfo.prototype.isClear=function(){return 1==this.drm.length&&this.drm[0]==shakaAssets.KeySystem.CLEAR};ShakaDemoAssetInfo.prototype.setExtraConfig=function(a){this.extraConfig=a;return this};ShakaDemoAssetInfo.prototype.setRequestFilter=function(a){this.requestFilter=a;return this};
ShakaDemoAssetInfo.prototype.setResponseFilter=function(a){this.responseFilter=a;return this};ShakaDemoAssetInfo.prototype.addLicenseServer=function(a,b){this.licenseServers.set(a,b);return this};ShakaDemoAssetInfo.prototype.addLicenseRequestHeader=function(a,b){this.licenseRequestHeaders.set(a,b);return this};ShakaDemoAssetInfo.prototype.addExtraText=function(a){this.extraText.push(a);return this};ShakaDemoAssetInfo.prototype.markAsFocused=function(){this.focus=!0;return this};
ShakaDemoAssetInfo.prototype.markAsFeatured=function(a){this.isFeatured=!0;this.shortName=a||this.shortName;return this};ShakaDemoAssetInfo.prototype.markAsDisabled=function(){this.disabled=!0;return this};ShakaDemoAssetInfo.prototype.toJSON=function(){var a={},b;for(b in this){var c=this[b];if(c instanceof Map){var d={__type__:"map"};c=$jscomp.makeIterator(c.entries());for(var e=c.next();!e.done;e=c.next())e=e.value,d[e[0]]=e[1];a[b]=d}else a[b]=c}return a};
...
"manifest.dash.ignoreEmptyAdaptationSet").addBoolInput_("Ignore HLS Text Stream Failures","manifest.hls.ignoreTextStreamFailures").addNumberInput_("Availability Window Override","manifest.availabilityWindowOverride",!0,!1,!0).addTextInput_("Clock Sync URI","manifest.dash.clockSyncUri").addBoolInput_("Ignore DRM Info","manifest.dash.ignoreDrmInfo").addNumberInput_("Default Presentation Delay","manifest.dash.defaultPresentationDelay").addNumberInput_("Ignore DASH suggestedPresentationDelay","manifest.dash.ignoreSuggestedPresentationDelay").addBoolInput_("Ignore Min Buffer Time",
"manifest.dash.ignoreMinBufferTime").addBoolInput_("Disable audio","manifest.disableAudio").addBoolInput_("Disable video","manifest.disableVideo").addBoolInput_("Disable text","manifest.disableText");this.addRetrySection_("manifest","Manifest")};
...
a.classList.contains("hidden")||b.remakeAssetCards_()})};shakaDemo.Front.init=function(){var a=shakaDemoMain.addNavButton("front");shakaDemoFront=new shakaDemo.Front(a)};
...
(h={title:a.name,artwork:[{src:a.iconUri}]},a.source!=shakaAssets.Source.UNKNOWN&&(h.artist=a.source),navigator.mediaSession.metadata=new MediaMetadata(h));d.leaveTryBlock(3);break;case 2:if(k=l=d.enterCatchBlock(),k.code==shaka.util.Error.Code.LOAD_INTERRUPTED)console.debug("load() interrupted");else b.onError_(k);case 3:b.remakeHash(),d.jumpToEnd()}})})};
...
d.textContent);break}c=$jscomp.makeIterator(["compiled","debug_compiled","uncompiled"]);for(d=c.next();!d.done;d=c.next())d=d.value,document.getElementById(d.split("_").join("-")+"-link").hasAttribute("disabled")&&b.push("build="+d);this.noInput_&&b.push("noinput");this.nativeControlsEnabled_&&b.push("nativecontrols");if(shaka.log&&shaka.log.currentLevel!=shaka.log.MAX_LOG_LEVEL)switch(shaka.log.currentLevel){case shaka.log.Level.INFO:b.push("info");break;case shaka.log.Level.DEBUG:b.push("debug");
break;case shaka.log.Level.V2:b.push("vv");break;case shaka.log.Level.V1:b.push("v")}this.setNewHashSilent_(b.join(";"))}};shakaDemo.Main.prototype.setNewHashSilent_=function(a){history.replaceState(null,"",document.location.pathname+"#"+a)};shakaDemo.Main.prototype.getHamburgerMenu=function(){return document.getElementById("hamburger-menu-contents")};shakaDemo.Main.prototype.hideNode_=function(a){a.classList.add("hidden")};shakaDemo.Main.prototype.showNode_=function(a){a.classList.remove("hidden")};
shakaDemo.Main.prototype.addNavButton=function(a){var b=this,c=document.getElementById("nav-button-container"),d=document.getElementById("contents"),e=document.getElementById("nav-button-"+a),f=this.getParams_();(a=f.panel==encodeURI(e.textContent))||f.panel||(a=null!=e.getAttribute("defaultselected"));var g=document.createElement("div");this.hideNode_(g);d.appendChild(g);f=function(){for(var a=$jscomp.makeIterator(c.childNodes),f=a.next();!f.done;f=a.next())f=f.value,f.nodeType==Node.ELEMENT_NODE&&
f.classList.remove("mdl-button--accent");a=$jscomp.makeIterator(d.childNodes);for(f=a.next();!f.done;f=a.next())f=f.value,f.nodeType==Node.ELEMENT_NODE&&b.hideNode_(f);e.classList.add("mdl-button--accent");b.showNode_(g);b.remakeHash();b.dispatchEventWithName_("shaka-main-page-changed");g.scrollIntoView({behavior:"smooth",block:"start"})};e.addEventListener("click",f);a&&Promise.resolve().then(f);return g};
...
shakaDemo.Search=function(a){var b=this;this.desiredFeatures_=[];this.makeSearchDiv_(a);this.assetCards_=[];this.resultsDiv_=document.createElement("div");a.appendChild(this.resultsDiv_);document.addEventListener("shaka-main-selected-asset-changed",function(){b.updateSelected_()});document.addEventListener("shaka-main-offline-progress",function(){b.updateOfflineProgress_()});document.addEventListener("shaka-main-page-changed",function(){b.resultsDiv_.childNodes.length||a.classList.contains("hidden")||b.remakeResultsDiv_()})};
shakaDemo.Search.init=function(){var a=shakaDemoMain.addNavButton("search");shakaDemoSearch=new shakaDemo.Search(a)};shakaDemo.Search.prototype.createAssetCardFor_=function(a){var b=this;return new shakaDemo.AssetCard(this.resultsDiv_,a,!1,function(c){var d=shakaDemoMain.getAssetUnsupportedReason(a,!1);d?c.markAsUnsupported(d):(c.addButton("Play",function(){shakaDemoMain.loadAsset(a);b.updateSelected_()}),c.addStoreButton())})};
...
shakaDemo.Search.prototype.makeBooleanInput_=function(a,b,c,d){var e=this;a.addRow(b,d,"significant-right-padding");new shakaDemo.BoolInput(a,b,function(a){a.checked?e.addDesiredTerm_(b,c,[b]):e.removeDesiredTerm_(b,c);e.remakeResultsDiv_();componentHandler.upgradeDom()})};
shakaDemo.Search.prototype.makeSelectInput_=function(a,b,c,d){var e=this;a.addRow(null,null);for(var f={},g=$jscomp.makeIterator(c),h=g.next();!h.done;h=g.next())if(h=h.value,"DRM"==d)for(var l in shakaAssets.KeySystem){if(shakaAssets.KeySystem[l]==h){f[h]=l.split("_").map(function(a){return a[0]+a.substr(1).toLowerCase()}).join(" ");break}}else f[h]=h;var k=f.Unspecified="Unspecified";a=new shakaDemo.SelectInput(a,b,function(a){"Unspecified"!=a.value?e.addDesiredTerm_(a.value,d,c):e.removeDesiredTerm_(k,
d);k=a.value;e.remakeResultsDiv_();componentHandler.upgradeDom()},f);a.extra().textContent=b;a.input().value="Unspecified"};
shakaDemo.Search.prototype.makeSearchDiv_=function(a){var b=shakaAssets.Feature,c=shakaDemo.Search.TermType.FEATURE,d=shakaDemo.Search.TermType.DRM,e=shakaDemo.Search.TermType.SOURCE,f=new shakaDemo.InputContainer(a,null,shakaDemo.InputContainer.Style.FLEX,null);this.makeSelectInput_(f,"Manifest",[b.DASH,b.HLS],c);this.makeSelectInput_(f,"Container",[b.MP4,b.MP2TS,b.WEBM],c);this.makeSelectInput_(f,"DRM",Object.values(shakaAssets.KeySystem),d);this.makeSelectInput_(f,"Source",Object.values(shakaAssets.Source).filter(function(a){return"Custom"!=
a}),e);a=new shakaDemo.InputContainer(a,null,shakaDemo.InputContainer.Style.FLEX,null);this.makeBooleanInput_(a,b.LIVE,c,"Filters for assets that are live.");this.makeBooleanInput_(a,b.HIGH_DEFINITION,c,"Filters for assets with at least one high-definition video stream.");this.makeBooleanInput_(a,b.XLINK,c,"Filters for assets that have XLINK tags in their manifests, so that they can be broken into multiple files.");this.makeBooleanInput_(a,b.SUBTITLES,c,"Filters for assets with caption tracks, or embedded captions.");
this.makeBooleanInput_(a,b.TRICK_MODE,c,"Filters for assets that have special video tracks to be used in trick mode playback (aka fast-forward).");this.makeBooleanInput_(a,b.SURROUND,c,"Filters for assets with at least one surround sound audio track.");this.makeBooleanInput_(a,b.OFFLINE,c,"Filters for assets that can be stored offline.");this.makeBooleanInput_(a,b.STORED,c,"Filters for assets that have been stored offline.")};
