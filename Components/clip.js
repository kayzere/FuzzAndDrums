...
const ICON_PLAY_BUTTON = new Icon(
  require("../assets/images/ic_play_arrow_white_36dp.png"),
  34,
  51
);
const ICON_PAUSE_BUTTON = new Icon(
  require("../assets/images/ic_pause_white_36dp.png"),
  34,
  51
);
const ICON_STOP_BUTTON = new Icon(
  require("../assets/images/ic_stop_white_36dp.png"),
  22,
  22
);
const ICON_FORWARD_BUTTON = new Icon(
  require("../assets/images/ic_fast_forward_white_36dp.png"),
  33,
  25
);
const ICON_BACK_BUTTON = new Icon(
  require("../assets/images/ic_fast_rewind_white_36dp.png"),
  33,
  25
);

const ICON_LOOP_ALL_BUTTON = new Icon(
  require("../assets/images/ic_repeat_white_36dp.png"),
  77,
  35
);
const ICON_LOOP_ONE_BUTTON = new Icon(
  require("../assets/images/ic_repeat_one_white_36dp.png"),
  77,
  35
);

const ICON_MUTED_BUTTON = new Icon(
  require("../assets/images/ic_volume_off_white_36dp.png"),
  67,
  58
);
const ICON_UNMUTED_BUTTON = new Icon(
  require("../assets/images/ic_volume_up_white_36dp.png"),
  67,
  58
);
...
const BUFFERING_STRING = "...Preparation...";
...
export default class App extends React.Component {
  constructor(props) {
    ...
    this.currentclip.isVideo = false;
    this.index = 0;
  ...
  _updateScreenForLoading(isLoading) {
    if (isLoading) {
      ...
      this.setState({
        ...
        showVideo: this.currentclip.isVideo,
        isLoading: false
      });
    }
  }
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.timestampRow}>
            ...
            >
              {this.state.isBuffering ? BUFFERING_STRING : "Have fun"}
            </Text>
            <Text
              style={[
                styles.text,
...
const styles = StyleSheet.create({
  ...
  volumeSlider: {
    width: DEVICE_WIDTH / 1.1 - ICON_MUTED_BUTTON.width,
  },
